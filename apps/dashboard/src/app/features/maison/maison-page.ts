...
const ENSEIGNE_DOMAINS: Record<string, string> = {
  ...
  // ── Ajouts d'après les enseignes réelles de la base ──
  'a&w':                 'aw.ca',
  'adonis':              'groupeadonis.ca',
  'amazon prime':        'primevideo.com',
  'banq':                'banq.qc.ca',
  'bath & body works':   'bathandbodyworks.com',
  'bulk barn':           'bulkbarn.ca',
  'harvey\'s':           'harveys.ca',
  'hello fresh':         'hellofresh.ca',
  'homesense':           'homesense.ca',
  'les 3 brasseurs':     '3brasseurs.ca',
  'lepointdevente.com':  'lepointdevente.com',
  'marshall\'s':         'marshalls.ca',
  'mcdonald\'s':         'mcdonalds.com',
  'mont orford':         'sepaq.com',
  'montréal en lumière': 'montrealenlumiere.com',
  'playstation':         'playstation.com',
  'poste canada':        'canadapost-postescanada.ca',
  'première moisson':    'premieremoisson.com',
  'queue de castor':     'beavertails.com',
  'saq':                 'saq.com',
  'spa nordic station':  'spanordicstation.com',
  'time out market':     'timeoutmarket.com',
