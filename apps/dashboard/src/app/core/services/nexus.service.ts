...
import { KodiStatus, SystemMetrics, AbsStatus, AbsLibraryItem, PsnStatus, WS_EVENTS, LogEntry } from '@nexus/shared-types';
...
export class NexusService {
  ...
  readonly kodiStatus = signal<KodiStatus>({ connected: false, nowPlaying: null });
  readonly absStatus  = signal<AbsStatus>({ connected: false, activeSessions: [] });
